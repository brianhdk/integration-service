...
namespace Vertica.Integration.Infrastructure.Database.Migrations
{
	...
	{
		public MigrationDb(DatabaseServer databaseServer, ConnectionString connectionString, Assembly assembly, string namespaceContainingMigrations, string identifyingName = null, int timeout = 300)
        {
